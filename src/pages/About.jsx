        ...
        <div className="bg-base-100 min-h-screen pt-28 pb-20 overflow-hidden transition-colors duration-300">
            ...
            <section className="max-w-4xl mx-auto px-6 text-center mb-24">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-base-content uppercase italic mt-6 mb-8 leading-tight">
                        We Bridge the Gap <br />
                        <span className="text-orange-600">to Knowledge</span>
                    </h1>
                    <p className="text-base-content/60 text-lg md:text-xl font-medium leading-relaxed italic border-l-4 border-orange-500 pl-6 text-left max-w-2xl mx-auto">
            ...
            <section className="bg-base-200 py-20 border-y border-base-300 mb-24 relative">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    {highlights.map((item, index) => (
                        <motion.div 
                            ...
                            className="bg-base-100 p-8 rounded-[2.5rem] shadow-sm border border-base-300 hover:shadow-xl transition-all group"
                        >
                            ...
                            <h2 className="text-4xl font-black text-base-content mb-1">{item.value}</h2>
                            <p className="text-orange-600 font-black uppercase text-[10px] tracking-widest mb-2">{item.label}</p>
                            <p className="text-base-content/40 text-xs font-medium">{item.desc}</p>
                        </motion.div>
                    ))}
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 mb-32">
                ...
                <div className="flex flex-col justify-center py-10">
                    <h3 className="text-3xl font-black uppercase italic mb-6 text-base-content">The Ultimate Goal</h3>
                    ...
                    <div className="p-8 bg-orange-50/10 rounded-[2.5rem] border-2 border-dashed border-orange-200/50">
            ...
            <section className="max-w-7xl mx-auto px-6 text-center">
                <div className="py-20 border-t border-base-300">
                    <h2 className="text-2xl md:text-4xl font-black text-base-content/20 uppercase italic tracking-tighter">
