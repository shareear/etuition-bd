    ...
    return (
        <div className="bg-base-200 min-h-screen pt-28 pb-20 px-4 transition-colors duration-300">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-base-100 rounded-[3rem] shadow-xl overflow-hidden border border-base-300 mb-10 transition-colors duration-300">
                    ...
                    <div className="px-10 pb-10 flex flex-col md:flex-row items-end gap-8 -mt-20">
                        <div className="relative">
                            <img 
                                src={tutor.image} 
                                alt={tutor.name} 
                                className="w-44 h-44 rounded-[2.5rem] object-cover border-8 border-base-100 shadow-2xl transition-all"
                            />
                            <div className="absolute bottom-4 right-0 bg-blue-500 text-white p-2 rounded-xl shadow-lg border-4 border-base-100 transition-all">
                                <FaCheckCircle />
                            </div>
                        </div>
                        <div className="flex-1 mb-4">
                            <h1 className="text-4xl font-black text-base-content uppercase italic flex items-center gap-3">
                                {tutor.name} <span className="bg-orange-100 text-orange-600 text-[10px] px-3 py-1 rounded-full not-italic">Featured</span>
                            </h1>
                            <p className="text-base-content/60 font-bold uppercase tracking-widest text-xs flex items-center gap-2 mt-2">
                                <FaGraduationCap className="text-orange-600" /> {tutor.institution || "Professional Educator"}
                            </p>
                        </div>
                        <button 
                            onClick={handleHireRequest}
                            className="btn btn-primary h-16 px-10 rounded-2xl uppercase font-black italic shadow-xl shadow-orange-200/50 mb-4 w-full md:w-auto"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-2 space-y-10">
                        ...
                        {/* About/Bio Section */}
                        <div className="bg-base-100 rounded-[2.5rem] p-10 border border-base-300 transition-colors duration-300">
                            <h3 className="text-xl font-black uppercase italic mb-6 border-l-4 border-orange-600 pl-4 text-base-content">Professional Bio</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-base-100 rounded-[2.5rem] p-8 border border-base-300 transition-colors duration-300">
                                <FaMoneyBillWave className="text-emerald-600 text-3xl mb-4" />
                                <h4 className="text-xs font-black uppercase tracking-widest text-base-content/40 mb-2">Expected Salary</h4>
                                <p className="text-2xl font-black italic text-base-content">৳{tutor.expectedSalary || "Negotiable"}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-8">
                        <div className="bg-base-100 rounded-[2.5rem] p-8 border border-base-300 transition-colors duration-300">
                            <h4 className="font-black uppercase italic mb-6 text-base-content/40 text-xs tracking-widest">Quick Information</h4>
                            <div className="space-y-6">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-base-200 rounded-xl flex items-center justify-center text-base-content/60"><FaMapMarkerAlt /></div>
                                    <div>
                                        <p className="text-[10px] font-black uppercase text-base-content/40">Location</p>
                                        <p className="font-bold text-base-content/80 text-sm">{tutor.location || tutor.address || "Dhaka, BD"}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-base-200 rounded-xl flex items-center justify-center text-base-content/60"><FaCalendarAlt /></div>
                                    <div>
                                        <p className="text-[10px] font-black uppercase text-base-content/40">Availability</p>
                                        <p className="font-bold text-base-content/80 text-sm">3-4 Days Per Week</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-base-200 rounded-xl flex items-center justify-center text-base-content/60"><FaStar className="text-orange-500" /></div>
                                    <div>
                                        <p className="text-[10px] font-black uppercase text-base-content/40">Total Reviews</p>
                                        <p className="font-bold text-base-content/80 text-sm">12 Students Helped</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Safe Hiring Note */}
                        <div className="bg-orange-50 dark:bg-orange-950/20 rounded-[2.5rem] p-8 border-2 border-dashed border-orange-200 dark:border-orange-900/50 transition-colors duration-300">
                            <h5 className="font-black uppercase italic mb-2 text-orange-700 dark:text-orange-500">Safety Tip</h5>
